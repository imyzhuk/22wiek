export const selections: {
  [key: string]: { id: number; name: string; link: string; image: string }[];
} = {
  100: [
    {
      id: 1,
...
export const categoryRecommendations: {
  ...
  100: [
    { id: 1, name: 'LG', link: '/info/brands/lg' },
    { id: 2, name: 'Samsung', link: '/info/brands/samsung' },
    { id: 3, name: 'Philips', link: '/info/brands/philips' },
    { id: 4, name: 'Beko', link: '/info/brands/beko' },
    { id: 5, name: 'Kitfort', link: '/info/brands/kitfort' },
    { id: 6, name: 'Vitek', link: '/info/brands/vitek' },
  ],
};
